    ...
    class Data
        def getHighlight
            daum_highlight = 
            {
                ...
                #16강
                "프랑스"=>{"아르헨티나"=>"m_80016563"},
                "우루과이"=>{"포르투갈"=>"m_80016564"},
                "스페인"=>{"러시아"=>"m_80016565"},
                "크로아티아"=>{"덴마크"=>"m_80016566"},
                "브라질"=>{"멕시코"=>"m_80016567"},
                "벨기에"=>{"일본"=>"m_80016568"},
                "스웨덴"=>{"스위스"=>"m_80016569"},
                "콜롬비아"=>{"잉글랜드"=>"m_80016570"}
            }
        ...
        def getTourner
            game = {
                "20180706" => {"23:00" => "m_80016571"},
                "20180707" => {"03:00" => "m_80016572", "23:00" => "m_80016573"},
                "20180708" => {"03:00" => "m_80016574"},
                "20180711" => {"03:00" => "m_80016575"},
                "20180712" => {"03:00" => "m_80016576"},
                "20180714" => {"23:00" => "m_80016577"},
                "20180716" => {"00:00" => "m_80016578"}
            }
            return game
        end
    end
